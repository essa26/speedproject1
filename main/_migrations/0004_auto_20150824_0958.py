    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_staff', models.BooleanField(default=False, help_text='Lets the user login to Django admin dashboard', verbose_name='staff status')),
                ('is_active', models.BooleanField(default=True, help_text='Marks the account as usable', verbose_name='active')),
